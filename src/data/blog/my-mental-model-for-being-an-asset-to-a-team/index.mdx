...
<Callout type='warning' title='Deprecated'>
  Due to the **advances in agentic coding** in the past year, my work ethic has changed to be more AI native while understanding the [effects (positive and negative).](/blog/ai-effects-on-skills) A writeup on the same will be published soon. 
  
  No doubt, the **approach below is the foundation** but there are some important changes which will be included in the aforementioned WIP blog.
</Callout>

I ~currently~ used to work as a software engineer at [bravestudio Inc](https://bravestudio.co.jp/)
